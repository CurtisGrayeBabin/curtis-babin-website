      ...
      <section className={`${layoutPadding}`}>
        <div className={about}>
          ...
          <p>
            ...
            Nanodegree certification through Udacity. My skills also include
            React, Responsive Design, and UI Design. So thank you for stopping
            by! Catch me being active on{" "}
